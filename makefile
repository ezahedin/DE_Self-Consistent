...
runfile: main.o matrix.o cmatrix.o kron.o problem.o utilities.o DE.o EvalUT.o printi.o matgen.o
	$(ICC) $(LIB2) matgen.o printi.o EvalUT.o DE.o utilities.o problem.o kron.o cmatrix.o matrix.o main.o -o runfile -O3
